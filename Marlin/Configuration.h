...
#define STRING_CONFIG_H_AUTHOR "Axam  (based on Alexander, default config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 104.88
  #define DEFAULT_bedKi 20
  #define DEFAULT_bedKd 366.59
